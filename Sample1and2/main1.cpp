...
int main(){
            ...
            while (getline(inputFile, line)) {
                ...
                if (line.find(';') != string::npos)
                {
                    if (fullCommand.find("CREATE TABLE") != string::npos)   // first one find the keyword 'create table' and call out function
                    {
                        ...
                        {
                            outputFile.open("fileOutput1.csv");
                        }
                        else
                        {
                            outputFile.open("fileOutput2.csv");
                        }
    ...
    if (customer_count == 0)
    {
        ...
        outputFile << "Customer ID, Customer Name, Customer City, Customer State, Customer Country, Customer Phone, Customer Email" << endl;
