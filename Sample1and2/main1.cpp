...
int main(){
    ...
    if (customer_count == 0)
    {
        ...
        if (filename == "fileInput1.mdb")
        {
            ...
            while (getline(inputFile, line))
            {
                ...
                outputTxtFile << ">" << line << endl;
                    ...
                    outputTxtFile << "C:\\mariadb\\fileInput1.mdb" << endl;
                    }
                } else {
                    cout << line << endl;
                    outputTxtFile << line << endl;
        ...
        {
            ifstream inputFile("fileInput2.mdb");
            while (getline(inputFile, line))
            {
                if (line.find("CREATE", 0) == 0 || line.find("DATABASES", 0) == 0 ||
                ...
                outputTxtFile << ">" << line << endl;
                    ...
                    outputTxtFile << "C:\\mariadb\\fileInput2.mdb" << endl;
                    }
                } else {
                    cout << line << endl;
                    outputTxtFile << line << endl;
        ...
        outputTxtFile << "Customer ID, Customer Name, Customer City, Customer State, Customer Country, Customer Phone, Customer Email" << endl;
